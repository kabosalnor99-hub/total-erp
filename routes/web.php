...
// =====================================================================
// إضافات المرحلة 8 — أضف هذا الكود داخل middleware group في routes/web.php
// =====================================================================
...
Route::prefix('settings')->name('settings.')->middleware(['auth', 'setlocale'])->group(function () {
...
Route::prefix('reports')->name('reports.')->middleware(['auth', 'setlocale', 'permission:reports.view'])->group(function () {
...
Route::prefix('notifications')->name('notifications.')->middleware(['auth', 'setlocale'])->group(function () {

    // List all notifications
    Route::get('/', [NotificationController::class, 'index'])->name('index');

    // Mark single notification as read (and redirect to URL if set)
