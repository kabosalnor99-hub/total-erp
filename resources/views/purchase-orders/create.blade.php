        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mt-6">
            <div class="flex items-center justify-between p-5 border-b">
                ...
                <div class="flex items-center gap-2">
                    {{-- زر تحديد متعدد --}}
                    <button type="button" @click="openMultiModal()"
                            class="inline-flex items-center gap-1.5 border border-teal-600 text-teal-600 hover:bg-teal-50 px-3 py-1.5 rounded-lg text-sm font-medium transition">
